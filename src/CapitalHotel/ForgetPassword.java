...
public class ForgetPassword extends javax.swing.JFrame {
    ...
    public ForgetPassword() {
        initComponents();
        emailtf.setText("name@gmail.com");
        emailtf.selectAll();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ResultSet rs=Select.getSelect("select *from user where email='"+email+"'");
        try
        { 
        if(rs.next())
        {
            sequrityQuestion=rs.getString(4);
            answer=rs.getString(5);
            ForgetPassword1.seq=sequrityQuestion;
            ForgetPassword1.e=email;
            ForgetPassword1.ans=answer;
            setVisible(false);
            new ForgetPassword1().setVisible(true);
        }
        else 
        {
            JOptionPane.showMessageDialog(this, "Email isn`t correct");
            emailtf.setText("");
           // emailtf.setCursor(null);
        }
        }catch(Exception e)
        {
